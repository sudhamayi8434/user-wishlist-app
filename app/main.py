...
# postgresql://username:passw ord@port/databse
...
def get():
	...
	return render_template('index.html', username=username, get=1, msg='(From DataBase)', place=user_data[b'place'].decode('utf-8'), food=user_data[b'food'].decode('utf-8'))
